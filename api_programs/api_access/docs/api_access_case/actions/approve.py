"""Action handler seed for api_access_case:approve."""
...
ACTION_ID = "approve"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'approved', 'rejected', 'suspended'], 'transitions_to': 'approved'}
