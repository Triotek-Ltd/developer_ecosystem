"""Relation service seed for sdk_package."""
...
DOC_ID = "sdk_package"
RELATED_DOCS = [{'doc_id': 'sdk_release', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'developer_documentation_release', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
