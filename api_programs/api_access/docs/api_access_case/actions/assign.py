"""Action handler seed for api_access_case:assign."""
...
ACTION_ID = "assign"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'approved', 'rejected', 'suspended'], 'transitions_to': 'in_review'}
