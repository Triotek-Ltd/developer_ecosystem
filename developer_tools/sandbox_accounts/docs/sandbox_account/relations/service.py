"""Relation service seed for sandbox_account."""
...
RELATED_DOCS = [{'doc_id': 'sandbox_usage_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'developer_test_run', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'developer_support_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'partner_api_key', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'developer/program access context from partner_api_key or developer account records'}]
