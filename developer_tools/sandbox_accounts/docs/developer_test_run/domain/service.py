"""Business-domain service seed for Developer Test Run."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['sandbox_account', 'sandbox_usage_record', 'sdk_release', 'api_program_record', 'party_record'], 'action_targets': {'create': None, 'queue': None, 'start': None, 'pass': None, 'fail': None, 'archive': 'archived'}, 'action_side_effects_file': None}
