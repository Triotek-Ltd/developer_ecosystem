"""Action handler seed for api_access_case:suspend."""
...
ACTION_ID = "suspend"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'approved', 'rejected', 'suspended'], 'transitions_to': None}
