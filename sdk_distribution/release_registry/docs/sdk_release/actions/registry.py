"""Action registry seed for sdk_release."""
...
DOC_ID = "sdk_release"
ALLOWED_ACTIONS = ['create', 'review', 'approve', 'publish', 'supersede', 'archive']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['draft', 'approved', 'published', 'superseded'], 'transitions_to': None}, 'review': {'allowed_in_states': ['draft', 'approved', 'published', 'superseded'], 'transitions_to': None}, 'approve': {'allowed_in_states': ['draft', 'approved', 'published', 'superseded'], 'transitions_to': 'approved'}, 'publish': {'allowed_in_states': ['draft', 'approved', 'published', 'superseded'], 'transitions_to': 'published'}, 'supersede': {'allowed_in_states': ['draft', 'approved', 'published', 'superseded'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['draft', 'approved', 'published', 'superseded'], 'transitions_to': 'archived'}}
