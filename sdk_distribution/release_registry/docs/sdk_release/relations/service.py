"""Relation service seed for sdk_release."""
...
DOC_ID = "sdk_release"
RELATED_DOCS = [{'doc_id': 'sdk_package', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'developer_documentation_release', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'party_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'source_field': 'party', 'doc_id': 'party_record', 'mode': 'context'}]

BORROWED_FIELDS = [{'description': 'package-family context from sdk_package'}, {'field_id': 'party', 'doc_id': 'party_record', 'description': 'Borrow context from party_record through party.'}]
