...
RELATED_DOCS = [{'doc_id': 'api_program_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'api_access_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'sandbox_account', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'program scope'}, {'description': 'access policy from api_program_record'}]
