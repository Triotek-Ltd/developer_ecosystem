"""Action registry seed for developer_documentation_release."""
...
ALLOWED_ACTIONS = ['create', 'review', 'publish', 'supersede', 'archive']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['draft', 'reviewed', 'published', 'superseded'], 'transitions_to': None}, 'review': {'allowed_in_states': ['draft', 'reviewed', 'published', 'superseded'], 'transitions_to': 'reviewed'}, 'publish': {'allowed_in_states': ['draft', 'reviewed', 'published', 'superseded'], 'transitions_to': 'published'}, 'supersede': {'allowed_in_states': ['draft', 'reviewed', 'published', 'superseded'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['draft', 'reviewed', 'published', 'superseded'], 'transitions_to': 'archived'}}
