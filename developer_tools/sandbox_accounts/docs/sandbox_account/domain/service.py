...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['sandbox_usage_record', 'developer_test_run', 'developer_support_case', 'partner_api_key'], 'action_targets': {'create': None, 'provision': None, 'activate': 'active', 'suspend': None, 'expire': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
