"""Relation service seed for developer_documentation_release."""
...
RELATED_DOCS = [{'doc_id': 'sdk_release', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'sdk_package', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'api_program_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'party_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'sdk_api_program', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'source_field': 'party', 'doc_id': 'party_record', 'mode': 'context'}]

BORROWED_FIELDS = [{'description': 'related SDK/API context from linked records'}, {'field_id': 'party', 'doc_id': 'party_record', 'description': 'Borrow context from party_record through party.'}]
