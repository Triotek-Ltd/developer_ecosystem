"""Action handler seed for developer_test_run:pass."""
...
ACTION_ID = "pass"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['queued', 'running', 'passed', 'failed'], 'transitions_to': None}
