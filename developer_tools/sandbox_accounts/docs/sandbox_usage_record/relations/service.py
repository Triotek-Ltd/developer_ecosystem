"""Relation service seed for sandbox_usage_record."""
...
RELATED_DOCS = [{'doc_id': 'sandbox_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'developer_test_run', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'account tier'}, {'description': 'scope from sandbox_account'}]
