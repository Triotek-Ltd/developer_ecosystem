...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'issue_date': 'schedule_marker', 'related_api_program_record': 'relation_collection', 'related_api_access_case': 'relation_collection', 'related_sandbox_account': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'key_code', 'program_link', 'developer_partner_account'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'requested', 'lifecycle_states': ['requested', 'issued', 'active', 'suspended', 'revoked', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'issue': 'issued', 'activate': 'active', 'rotate': None, 'suspend': None, 'revoke': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['api_program_record', 'api_access_case', 'sandbox_account'], 'action_targets': {'create': None, 'issue': 'issued', 'activate': 'active', 'rotate': None, 'suspend': None, 'revoke': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
