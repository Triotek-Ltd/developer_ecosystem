"""Action handler seed for sandbox_account:provision."""
...
ACTION_ID = "provision"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['requested', 'provisioned', 'active', 'suspended', 'expired'], 'transitions_to': None}
