"""Relation service seed for api_program_record."""
...
RELATED_DOCS = [{'doc_id': 'partner_api_key', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'webhook_subscription', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'api_access_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'developer_documentation_release', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
