...
DOC_ID = "sdk_release"
RELATED_DOCS = [{'doc_id': 'sdk_package', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'developer_documentation_release', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'package-family context from sdk_package'}]
