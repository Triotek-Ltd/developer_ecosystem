...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'creation_date': 'schedule_marker', 'account_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'account_code', 'developer_identity', 'sandbox_tier'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'requested', 'lifecycle_states': ['requested', 'provisioned', 'active', 'suspended', 'expired', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'provision': None, 'activate': 'active', 'suspend': None, 'expire': None, 'archive': 'archived'}}
