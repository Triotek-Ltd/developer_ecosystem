...
RELATED_DOCS = [{'doc_id': 'sdk_release', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'sdk_package', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'api_program_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'related SDK/API context from linked records'}]
